              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Subtitle
                    const Text(
                      'Enter the email address that you can access right now. We\'ll send you an email to verify your account.',
                      style: TextStyle(
                    ...
                    // Email notification text with link
                    RichText(
                      text: const TextSpan(
                        style: TextStyle(
                          color: Colors.black87,
                        ...
                        children: [
                          TextSpan(text: 'You\'ll also receive emails from us and can opt out at any time. '),
                          TextSpan(
                            text: 'Learn more',
                            style: TextStyle(
                              color: Color(0xFF005FD5),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        onPressed: () {
                          Navigator.pop(context); // Go back to mobile number screen
                        },
